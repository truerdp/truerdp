...
import { syncCoinGateSchema } from "../../schemas/transaction.schemas.js"

export async function registerTransactionSyncRoutes(server: FastifyInstance) {
  server.post(
    "/transactions/:transactionId/sync-coingate",
    { preHandler: verifyAuth, schema: syncCoinGateSchema },
